...
#Region "Context Scope"
    ...
    Public Const SCARD_STATE_UNAWARE As Long = 0
    ...
    Public Const SCARD_STATE_IGNORE As Long = 1
    ...
    Public Const SCARD_STATE_CHANGED As Long = 2
    ...
    Public Const SCARD_STATE_UNKNOWN As Long = 4
    ...
    Public Const SCARD_STATE_UNAVAILABLE As Long = 8
    ...
    Public Const SCARD_STATE_ATRMATCH As Long = 64
    ...
    Public Const SCARD_STATE_EXCLUSIVE As Long = 128
    ...
    Public Const SCARD_STATE_INUSE As Long = 256
    ...
    Public Const SCARD_STATE_MUTE As Long = 512

    ''' <summary> 
    ''' This implies that the card in the reader has not been powered up. 
    ''' </summary> 
    'Public Const SCARD_STATE_UNPOWERED As Integer = 1024
    Public Const SCARD_STATE_UNPOWERED As Long = 1024
...
#Region "Error Codes"
    Public Const SCARD_F_INTERNAL_ERROR = &H80100001L
    Public Const SCARD_E_CANCELLED = &H80100002L
    Public Const SCARD_E_INVALID_HANDLE = &H80100003L
    Public Const SCARD_E_INVALID_PARAMETER = &H80100004L
    Public Const SCARD_E_INVALID_TARGET = &H80100005L
    Public Const SCARD_E_NO_MEMORY = &H80100006L
    Public Const SCARD_F_WAITED_TOO_Integer = &H80100007L
    Public Const SCARD_E_INSUFFICIENT_BUFFER = &H80100008L
    Public Const SCARD_E_UNKNOWN_READER = &H80100009L
    Public Const SCARD_E_TIMEOUT = &H8010000AL
    Public Const SCARD_E_SHARING_VIOLATION = &H8010000BL
    Public Const SCARD_E_NO_SMARTCARD = &H8010000CL
    Public Const SCARD_E_UNKNOWN_CARD = &H8010000DL
    Public Const SCARD_E_CANT_DISPOSE = &H8010000EL
    Public Const SCARD_E_PROTO_MISMATCH = &H8010000FL
    Public Const SCARD_E_NOT_READY = &H80100010L
    Public Const SCARD_E_INVALID_VALUE = &H80100011L
    Public Const SCARD_E_SYSTEM_CANCELLED = &H80100012L
    Public Const SCARD_E_NO_READERS_AVAILABLE = &H8010002EL
    Public Const SCARD_F_COMM_ERROR = &H80100013L
    Public Const SCARD_F_UNKNOWN_ERROR = &H80100014L
    Public Const SCARD_E_INVALID_ATR = &H80100015L
    Public Const SCARD_E_NOT_TRANSACTED = &H80100016L
    Public Const SCARD_E_READER_UNAVAILABLE = &H80100017L
    Public Const SCARD_P_SHUTDOWN = &H80100018L
    Public Const SCARD_E_PCI_TOO_SMALL = &H80100019L
    Public Const SCARD_E_READER_UNSUPPORTED = &H8010001AL
    Public Const SCARD_E_DUPLICATE_READER = &H8010001BL
    Public Const SCARD_E_CARD_UNSUPPORTED = &H8010001CL
    Public Const SCARD_E_NO_SERVICE = &H8010001DL
    Public Const SCARD_E_SERVICE_STOPPED = &H8010001EL
    Public Const SCARD_E_DIR_NOT_FOUND = &H80100023L
    Public Const SCARD_W_UNSUPPORTED_CARD = &H80100065L
    Public Const SCARD_W_UNRESPONSIVE_CARD = &H80100066L
    Public Const SCARD_W_UNPOWERED_CARD = &H80100067L
    Public Const SCARD_W_RESET_CARD = &H80100068L
    Public Const SCARD_W_REMOVED_CARD = &H80100069L
...
#Region "Protocol"
    ...
    ''' </summary> 
    Public Const SCARD_PROTOCOL_UNDEFINED = &H0L

    ''' <summary> 
    ''' T=0 is the active protocol. 
    ''' </summary> 
    Public Const SCARD_PROTOCOL_T0 = &H1L

    ''' <summary> 
    ''' T=1 is the active protocol. 
    ''' </summary> 
    Public Const SCARD_PROTOCOL_T1 = &H2L

    ''' <summary> 
    ''' Raw is the active protocol. 
    ''' </summary> 
    Public Const SCARD_PROTOCOL_RAW = &H10000L

    ''' <summary>
    ''' Use implicit PTS.
    ''' </summary>
    ''' <remarks></remarks>
    Public Const SCARD_PROTOCOL_DEFAULT = &H80000000L
...
#Region "Prototypes"
    ...
    Public Declare Function SCardListReaderGroups Lib "Winscard.dll" (ByVal hContext As Long, _
                                                                      ByRef mzGroups As String, _
                                                                      ByRef pcchGroups As Long) As Long
