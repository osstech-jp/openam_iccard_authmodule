<%--
   ...
   $Id: iccard.jsp,v 1.9 2008/12/23 21:24:32 ericow Exp $
    ...
    <jato:useViewBean className="com.sun.identity.authentication.UI.LoginViewBean">
        ...
        <head>
            ...
            try {
                ...
                resources = ResourceBundle.getBundle("amAuthICCard", locale);
            } catch (MissingResourceException mr) {
                resources = ResourceBundle.getBundle("amAuthICCard");
            }
                                ...
                                <jato:content name="validContent">
                                    ...
                                    <jato:content name="textBox">
                                        <form name="frm<jato:text name="txtIndex" />" action="blank"
                                            ...
                                            <div class="row">
                                                ...
                                                <input class="textbox" type="text" name="IDToken<jato:text name="txtIndex" />" id="IDToken<jato:text name="txtIndex" />" value="<jato:text name="txtValue" />" autocapitalize="off" />
                                            </div>
                                        </form>
                                    </jato:content>
                                    <jato:content name="password">
                                        <form name="frm<jato:text name="txtIndex" />" action="blank"
                                              onsubmit="defaultSubmit(); return false;" method="post">
                                            <div class="row">
                                                <label for="IDToken<jato:text name="txtIndex" />"><jato:text name="txtPrompt" defaultValue="Password:" escape="false" /><jato:content name="isRequired"><img src="<%= ServiceURI %>/images/required.gif" alt="Required Field" title="Required Field" width="7" height="14" /></jato:content></label>
